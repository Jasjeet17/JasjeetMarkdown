...
It can be seen from Figure\@ref(fig:carbon-plot) that there doesn't appear to be any difference in the strength of final carbon fibre due to change in the processing speeds. But when we look at Figure\@ref(fig:standard-plot) there does appear to be difference in fibre properties when fibre evolves through oxidation process. This difference is even more obvious in Figure\@ref(fig:second-plot) which is stiffness of the fibre. So these figures helped to understand that there is a difference in the mechanical properties of the fibre in the oxidation process but this effect seem to be disappearing after the carbonisation process.
